...
import de.rexlmanu.fairytab.utility.annotations.PluginLogger;
import de.rexlmanu.fairytab.utility.annotations.PostInit;
import de.rexlmanu.fairytab.utility.exceptions.PostInitializationException;
...
public class FairyTabModule extends AbstractModule implements TypeListener {
  ...
  protected void configure() {
    ...
    this.bindListener(Matchers.any(), this);
  }
